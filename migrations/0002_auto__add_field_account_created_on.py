...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('diablo_account', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 11, 19, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.created_on'
        db.delete_column('diablo_account', 'created_on')
